...
> = {
  ...
  GENERAL_AI_RULES: {
    ...
    isSecret: false,
    defaultVal: `1. Direct Answer First: Always answer the user's latest question directly and clearly first. If asked a general knowledge question, answer it without adding unsolicited nutrition or logging advice.
