...
export class AIRulesEngine {
  ...
  /**
   * Retrieves Admin-configured General AI Rules from System Settings
   */
  static async getGeneralAIRules(): Promise<string> {
    const defaultRules = `1. Ayurveda-First Priority: Always prioritize authentic Ayurvedic principles first (Ahara Rasas/6 tastes, Agni/digestive fire, Dosha balance: Vata/Pitta/Kapha, Viruddha Ahara/incompatible foods, and seasonal eating/Ritucharya), followed immediately by modern evidence-based sports & nutritional science.
